...
# # 输出的TUM格式文件路径
# tum_file = 'output_tum_format_single.txt'  # 请替换为实际路径
# # 斜方差阈值
# variance_threshold = 0.1
# extract_gnss_to_tum_format(bag_file, origin, tum_file, variance_threshold)

# Topics and their corresponding output files
topics = ['/3dm_ins/gnss1/fix', '/3dm_ins/gnss2/fix', '/imu/nav_sat_fix']
output_files = ['output_gnss1_tum_format.txt', 'output_gnss2_tum_format.txt', 'output_sbg_gnss_tum_format.txt' ]
# 斜方差阈值
variance_threshold = 0.1
extract_gnss_to_tum_format(bag_file, origin, topics, output_files, variance_threshold)